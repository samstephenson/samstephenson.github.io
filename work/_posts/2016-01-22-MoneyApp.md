...
thumb: /images/money-app/squarethumbs.jpg
---
...
It's a bit premature. There's a lot of the UX still to be prototyped and tested, but I couldn't resist pushing one screen forward and tightening it up a bit visually…

<section style="background:#ececec">
<img class="full" alt="money app visual development" src="/images/money-app/polish-progression.png">
</section>
...
### User testing
Organise a testing day and recruit participants to test user flows. Document the event. Get a few rounds of this in before end of term.